...
#[openapi(
    paths(
        ...
        crate::api_handlers::tenant::update_tenant,
        crate::api_handlers::tenant::delete_tenant,
        crate::api_handlers::node::list_nodes,
        crate::api_handlers::node::create_node,
        crate::api_handlers::node::get_node,
        crate::api_handlers::node::update_node,
        crate::api_handlers::node::delete_node,
        crate::api_handlers::network::list_networks,
        crate::api_handlers::network::create_network,
        crate::api_handlers::network::get_network,
        crate::api_handlers::network::update_network,
        crate::api_handlers::network::delete_network,
        crate::api_handlers::port::list_ports,
        crate::api_handlers::port::create_port,
        crate::api_handlers::port::get_port,
        crate::api_handlers::port::update_port,
        crate::api_handlers::port::delete_port,
        crate::api_handlers::network_policy::list_network_policies,
        crate::api_handlers::network_policy::create_network_policy,
        crate::api_handlers::network_policy::get_network_policy,
        crate::api_handlers::network_policy::update_network_policy,
        crate::api_handlers::network_policy::delete_network_policy,
        crate::api_handlers::qos_policy::list_qos_policies,
        crate::api_handlers::qos_policy::create_qos_policy,
        crate::api_handlers::qos_policy::get_qos_policy,
        crate::api_handlers::qos_policy::update_qos_policy,
        crate::api_handlers::qos_policy::delete_qos_policy,
        crate::api_handlers::mirror_policy::list_mirror_policies,
        crate::api_handlers::mirror_policy::create_mirror_policy,
        crate::api_handlers::mirror_policy::get_mirror_policy,
        crate::api_handlers::mirror_policy::update_mirror_policy,
        crate::api_handlers::mirror_policy::delete_mirror_policy,
        crate::api_handlers::service_chain::list_service_chains,
        crate::api_handlers::service_chain::create_service_chain,
        crate::api_handlers::service_chain::get_service_chain,
        crate::api_handlers::service_chain::update_service_chain,
        crate::api_handlers::service_chain::delete_service_chain,
        crate::api_handlers::ip_group::list_ip_groups,
        crate::api_handlers::ip_group::create_ip_group,
        crate::api_handlers::ip_group::get_ip_group,
        crate::api_handlers::ip_group::update_ip_group,
        crate::api_handlers::ip_group::delete_ip_group,
        crate::api_handlers::security_group::list_security_groups,
        crate::api_handlers::security_group::create_security_group,
        crate::api_handlers::security_group::get_security_group,
        crate::api_handlers::security_group::update_security_group,
        crate::api_handlers::security_group::delete_security_group,
        crate::api_handlers::route_table::list_route_tables,
        crate::api_handlers::route_table::create_route_table,
        crate::api_handlers::route_table::get_route_table,
        crate::api_handlers::route_table::update_route_table,
        crate::api_handlers::route_table::delete_route_table,
        crate::api_handlers::health_check::list_health_checks,
        crate::api_handlers::health_check::create_health_check,
        crate::api_handlers::health_check::get_health_check,
        crate::api_handlers::health_check::update_health_check,
        crate::api_handlers::health_check::delete_health_check,
        crate::api_handlers::backend_set::list_backend_sets,
        crate::api_handlers::backend_set::create_backend_set,
        crate::api_handlers::backend_set::get_backend_set,
        crate::api_handlers::backend_set::update_backend_set,
        crate::api_handlers::backend_set::delete_backend_set,
        crate::api_handlers::service::list_services,
        crate::api_handlers::service::create_service,
    ...
    components(
        schemas(
            ...
            aria_api::QosPolicyRule,
            aria_api::QosPolicySpec,
            aria_api::QosPolicyStatus,
            aria_api::QosPolicyResource,
            aria_api::QosPolicyListQuery,
            aria_api::CreateQosPolicyRequest,
            aria_api::UpdateQosPolicyRequest,
            aria_api::QosPolicyListResponse,
            aria_api::MirrorPolicyRule,
            aria_api::MirrorPolicySpec,
            aria_api::MirrorPolicyStatus,
            aria_api::MirrorPolicyResource,
            aria_api::MirrorPolicyListQuery,
            aria_api::CreateMirrorPolicyRequest,
            aria_api::UpdateMirrorPolicyRequest,
            aria_api::MirrorPolicyListResponse,
            aria_api::ServiceChainHop,
            aria_api::ServiceChainTapBinding,
            aria_api::ServiceChainSpec,
            aria_api::ServiceChainStatus,
            aria_api::ServiceChainResource,
            aria_api::ServiceChainListQuery,
            aria_api::CreateServiceChainRequest,
            aria_api::UpdateServiceChainRequest,
    ...
    tags(
        ...
        (name = "qos-policies", description = "QoS rate-limit policy resources"),
        (name = "mirror-policies", description = "Mirror policy resources"),
        (name = "service-chains", description = "Service chain resources"),
